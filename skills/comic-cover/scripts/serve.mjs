#!/usr/bin/env node
// Zero-dependency static server for a cover folder (ES modules and the .glb fetch don't work from file://).
...
if (process.argv[1] && fileURLToPath(import.meta.url) === realpathSync(process.argv[1])) {
  ...
  console.log(`comic cover → http://localhost:${s.address().port}`);
}
